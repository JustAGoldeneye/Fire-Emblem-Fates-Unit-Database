...
## Toimintoja
* Kirjautuminen
* Hahmojen, aseiden ja kykyjen lisääminen ja poistaminen (ylläpitäjälle)
* Hahmon varustuksen suunnittelu
* Taistelujoukkojen luominen
* Hahmojen lisääminen ja poistaminen taistelujoukosta
* Kaikkien hahmojen ja aseiden listaaminen
* Taistelujoukon hahmojen listaaminen
* Hahmojen ja aseiden etsiminen jonkin ominaisuuden perusteella
* Hahmojen kykyjen listaaminen
* Hahmon ja aseen ominaisuuksien listaaminen
* Hahmon todennäköisten stattien laskeminen jollakin tasolla hahmon alkuperäisten stattien ja stattien kasvutodennäköisyyksien perusteella
